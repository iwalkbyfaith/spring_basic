...
<body>
	...
	<script type="text/javascript">
		...
		$.getJSON("/replies/all/" + bno, function(data){
			...
			// 역시 내부에 콜백함수(로직이 실행되었을때 추가로 실행할 구문을 정의하기 위해 파라미터로 넣는 함수)
			// 를 이용해 data를 하나하나 향상된 for문형식을오 처리할때 실행구문을 적을 수 있습니다.
			$(data).each(function(){
			...
			// 버튼(testBtn)클릭시 발동되는 이벤트
						...
						//test버튼 클릭시 // 44,45,46,47,48,49,50번 라인 실행
			$("#testBtn").on("click",function(){
				
				// 1. #test에 넣어줄 문자를 생성합니다,.
				var strTest = "<a href='http://www.daum.net'>다음<a>";
