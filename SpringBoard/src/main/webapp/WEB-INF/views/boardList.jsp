			...
			<tbody>
				<c:forEach var="board" items="${boardList}">
					<tr> 
						...
						<td><a href="http://localhost:8181/boardDetail/${board.bno}?pageNum=${pageMaker.cri.pageNum}&searchType=${pageMaker.cri.searchType}&keyword=${pageMaker.cri.keyword}">${board.title}</a></td>
						<td>${board.writer}</td>
						<td>${board.regdate}</td>
